...
{
    class Node<Tkey, TValue> where Tkey : IComparable<Tkey>/*, IEnumerable<Tkey>*/
    {
        int minimumDegree;
        ...
        public List<Element<Tkey, TValue>> elements;
        ...
        public bool IsLeaf(Node<Tkey,TValue> node_x)
        {
            return false;
        }
        //-----------------
        ...
        int Height(int aCurrentHeight = 0)
        {
            ...
            {
                aCurrentHeight++;
                foreach (Node<Tkey, TValue> node in children)
        ...
        public Element<Tkey, TValue> Search(Node<Tkey,TValue> node_x, Tkey keyToSearch)
        {
            int index = 0; // i <= 1
        ...
        public int Key(Node<Tkey, TValue> childNode)
        {
            return 0;
        }
